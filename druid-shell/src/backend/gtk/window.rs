...
impl WindowBuilder {
    ...
    pub fn show_in_taskbar(&mut self, _show_in_taskbar: bool) {
        tracing::warn!("WindowBuilder::show_in_taskbar is currently unimplemented for gtk.");
    }

    pub fn set_always_on_top(&mut self, _always_on_top: bool) {
        tracing::warn!("WindowBuilder::set_always_on_top is currently unimplemented for gtk.");
    }
